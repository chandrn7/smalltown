...
SimpleNavigation::Configuration.run do |navigation|
  navigation.items do |n|
    n.item :web, safe_join([fa_icon('chevron-left fw'), t('settings.back', title: site_title)]), root_url
    ...
    n.item :admin, safe_join([fa_icon('cogs fw'), t('admin.title')]), admin_dashboard_url, if: proc { current_user.staff? } do |s|
      ...
      s.item :featured_topics, safe_join([fa_icon('hashtag fw'), t('admin.featured_topics.title')]), admin_featured_topics_url, highlights_on: %r{/admin/featured_topics}
